...
const Input = ({ placeholder, name, type, value, handleChange }) => (
  <input
    ...
    className="my-1 w-full rounded-sm p-2 outline-none bg-transparent text-white border-none text-sm white-glassmorphism"
  />
);
      ...
      <div className="w-full flex flex-row mf:flex-col items-center justify-between md:p-20 py-12 px-4">
        <div className="flex flex-col justify-center items-center mf:mr-10 mt-10 w-2 p-20">
          ...
          <button
            ...
            className="flex flex-row justify-center items-center my-5 bg-[#2952e3] p-2 rounded-full cursor-pointer hover:bg-[#2546bd] w-full"
          >
